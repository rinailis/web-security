...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 30 2024 г., 22:43
...
CREATE TABLE `user` (
  ...
  `birth` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `gender` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `user` (`id`, `email`, `password`, `phone`, `birth`, `gender`, `username`, `image`) VALUES
(1, 'EW', 'RWER', 'REW', 'REW', 'REW', 'QWE', 'ER'),
(2, 'masch.1305@gmail.com', '12321345678march&9!с', '+1(322)-222-22-22', 'Jan 1, 1970', 'м', 'rgerger', 'pngwing.com (12).png');
